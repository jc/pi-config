---
name: spec-issue
description: Collaboratively plan and create well-structured issue through interactive discussion. Use when the user wants to plan a feature, report a bug, or scope out work for implementation.
disable-model-invocation: true
---

Collaboratively plan and create well-structured issues through interactive discussion.
...
Create a issue in markdown format in .agents/issues
